...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/mutpy-pynguin-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14943&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/mutpy-pynguin-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `mutpy-pynguin` can be installed with:

```
conda install mutpy-pynguin
```

It is possible to list all of the versions of `mutpy-pynguin` available on your platform with:
